<template>
  <div class="page-container home-page">
    ...
    <div class="section">
      ...
      <p>
        此测评为迫选型测评，四个选项可能存在按个人体感都不符合的情况，尽可能依据工作经历按第一印象作最快的选择；如果不能确定，可回忆童年时的情况，或者以你最熟悉的人对你的评价来从中选择。
      </p>
    </div>
    ...
    <div class="section">
      ...
      <p class="warning">
        请注意：您的答题进度及结果仅保存在当前使用的浏览器中。如果更换设备、更换浏览器或清除浏览器数据，进度将无法保留，请务必使用同一设备和浏览器完成测评。
      </p>
    </div>
